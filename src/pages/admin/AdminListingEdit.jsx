...
export default function AdminListingEdit() {
  ...
  useEffect(() => {
    ...
    const formatted = {
      ...
      annual_payment: listing.annual_payment ? formatNumberReadable(String(listing.annual_payment)) : (listing.annualPayment ? formatNumberReadable(String(listing.annualPayment)) : ''),
      ...
      // Pricing visibility flags from DB
      show_price: listing.show_price !== false && listing.show_price !== 0,
      show_downpayment: listing.show_downpayment !== false && listing.show_downpayment !== 0,
      show_monthly: listing.show_monthly !== false && listing.show_monthly !== 0,
      show_full_price: listing.show_full_price === true || listing.show_full_price === 1,
      show_annual: listing.show_annual === true || listing.show_annual === 1,
      show_compound: listing.show_compound !== false && listing.show_compound !== 0,
    };
    setForm(formatted);
  ...
  const buildListingRow = () => ({
    ...
    show_downpayment: form?.show_downpayment !== false,
    show_monthly: form?.show_monthly !== false,
    show_full_price: form?.show_full_price === true,
    show_annual: form?.show_annual === true,
    show_compound: form?.show_compound !== false,
